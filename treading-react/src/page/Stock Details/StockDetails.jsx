...
import { Avatar, AvatarImage, Button, Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui'
...
function StockDetails() {
  ...
  const handleAddToWatchlist = () => {
    ...
    // Pass the coin object for optimistic update
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex items-center gap-4'>
          <Button 
            ...
            disabled={!coin.coinDetails?.id || watchlist.loading}
            variant="outline"
          >
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>How much would you like to spend?</DialogTitle>
              </DialogHeader>
              <TreadingForm />
            </DialogContent>
          </Dialog>
