      ...
      <div>
        ...
        >
          ...
          <div className='flex items-center space-x-2 border p-3 px-5 rounded-md'>
            ...
            />
            <Label htmlFor='r2'>
              <div className='bg-white rounded-md px-5 py-0.5 w-32 '>
                <img 
                className='h-8'
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Stripe_Logo%2C_revised_2016.svg/768px-Stripe_Logo%2C_revised_2016.svg.png" alt='STRIPE'/>
              </div>
