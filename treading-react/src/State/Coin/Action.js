...
export const getCoinList = (page) => async (dispatch) => {
    ...
    try{
        ...
        console.log("Error occurred during fetching coin list:", error);
    }
}
...
export const getTop50CoinList = () => async (dispatch) => {
    ...
    try{
        ...
        console.log("Error occurred during fetching top 50 coin list:", error);
...
export const searchCoin = (keyword) => async (dispatch) => {
    ...
    try{
        ...
        console.log("Error occurred during searching coin:", error);
